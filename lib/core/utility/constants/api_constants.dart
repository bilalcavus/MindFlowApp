...
class ApiConstants {
  ...
  static const Map<String, Map<String, String>> providerModels = {
    'openrouter': {
      ...
      'gemini-2.5-flash-image': 'google/gemini-2.5-flash-image-preview', // image generator
  ...
  static const Map<String, Map<String, dynamic>> chatTypes = {
    'mental_health': {
      ...
      'icon': 'brain',
      'color': 0xFF9C27B0,
      'image': 'assets/images/mental_health_support.png',
    ...
    'creative_writing': {
      ...
      'icon': 'pen',
      'color': 0xFF9900FF,
      'image': 'assets/images/creative_text_assistant.png',
      'preferred_models': ['gpt-4.1-nano', 'deepseek-r1-llama-free', 'llama-3.1-8b'],
    ...
    'career_guidance': {
      ...
      'icon': 'briefcase',
      'color': 0xFF2196F3,
      'image': 'assets/images/career_assistant.png',
      'preferred_models': ['gpt-4.1-nano', 'deepseek-r1-llama-free', 'llama-3.1-8b'],
    ...
    'technical_help': {
      ...
      'icon': 'code',
      'color': 0xFF4CAF50,
      'image': 'assets/images/technical_help.png',
      'preferred_models': ['gpt-4.1-nano', 'deepseek-r1-llama-free', 'llama-3.1-8b'],
    ...
    'general_chat': {
      ...
      'icon': 'chat',
      'color': 0xFF607D8B,
      'image': 'assets/images/general_chat.png',
      'preferred_models': ['gpt-4.1-nano', 'deepseek-r1-llama-free', 'llama-3.1-8b'],
