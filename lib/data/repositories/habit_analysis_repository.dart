...
class HabitAnalysisRepository {
  ...
  HabitAnalysisModel _mapToHabitAnalysisModel(Map<String, dynamic> row) {
    return HabitAnalysisModel.fromJson({
      'id': row['id'],
      'habits_json': jsonDecode(row['habits_json'] ?? '[]'),
      'user_id': row['user_id'],
      'entry_id': row['entry_id'],
      'analysis_type': row['analysis_type'],
      'positive_habits': jsonDecode(row['positive_habits_json'] ?? '[]'),
      'negative_habits': jsonDecode(row['negative_habits_json'] ?? '[]'),
      'habit_scores_json': jsonDecode(row['habit_scores_json'] ?? '{}'),
